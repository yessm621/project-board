...
class ArticleCommentControllerTest {
    ...
    @WithUserDetails(value = "yesTest", setupBefore = TestExecutionEvent.TEST_EXECUTION)
    @DisplayName("[view][GET] 댓글 등록 - 정상 호출")
    @Test
    void givenArticleCommentInfo_whenRequesting_thenSavesNewArticleComment() throws Exception {
        // Given
        long articleId = 1L;
        ArticleCommentRequest request = ArticleCommentRequest.of(articleId, "댓글");
    ...
    @Test
    void givenArticleCommentIdToDelete_whenRequesting_thenDeletesNewArticleComment() throws Exception {
        // Given
        long articleId = 1L;
        long articleCommentId = 1L;
        String userId = "yesTest";
